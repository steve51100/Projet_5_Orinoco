...
const teddyMain = document.getElementById('panier');
const teddyDiv = document.createElement('form');
...
if (storedTeddies == null || storedTeddies.length === 0) {
    ...
    for (storedTeddy of storedTeddies) {
        ...
        eachTeddy.className = 'row each_teddy';


        const teddiesCart = document.createElement('p');
        teddiesCart.className = 'col-6';
        eachTeddy.appendChild(teddiesCart);
        teddiesCart.textContent = storedTeddy.quantity + " " + storedTeddy.teddyName + " , " + "couleur:" + " " + storedTeddy.teddyColor;

        const teddyPrice = document.createElement('div');
        eachTeddy.appendChild(teddyPrice);
        teddyPrice.className = 'col-6 teddy_price';
        teddyPrice.id = i++;
